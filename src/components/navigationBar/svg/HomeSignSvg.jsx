...
function HomeSignSvg({width, height, color}) {
    ...
    return (
        <svg width={w} height={h} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                stroke={c} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"
            />
            <path d="M12 12V9" stroke={c} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M12 22V19" stroke={c} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M9 22H15" stroke={c} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}

export default HomeSignSvg;